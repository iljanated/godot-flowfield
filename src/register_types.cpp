...
void initialize_flowfield_module(ModuleInitializationLevel p_level) {
	...
	GDREGISTER_CLASS(IGCostField);
	GDREGISTER_CLASS(IGFlowField);
}
...
extern "C" {
// Initialization.
GDExtensionBool GDE_EXPORT flowfield_library_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, const GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization) {
